...
1. 예전에 손도 못대던 문제를 풀었다. 내가 성장했다는 것을 느끼게 해준다. 솔직히 뭔가 울컥했다. 그냥 문제 하나일 뿐인데 채점되는 동안 다른 화면을 보고 있었다. 뭔가 100%까지 보기 힘들었기 때문이다. 문제는 그냥 순열을 구해서 합을 다 구하는 방식 말 그대로 브루스 포스였다.

# 11/6

### 15654 N과 M (5)

1. sort()와 sort((a,b)=> a- b)의 차이를 알게되었다. 앞에는 문자열 기준으로 100이 40보다 먼저 온다.

# 11/5

### 15652 N과 M (4)

1. 똑같은 패턴인데 조건을 달아 미리 제거해야하는 연습을 하고 있다.

2. 이번 문제는 비오름차순 순열을 미리 제거 하는 것인데 순열을 만드는 과정에서 이전 보다 적은 수가 다음 인덱스에 배정될 경우 continue하는 방식으로 해결하였다.

# 11/4

### 15651 N과 M (3)

1. 재귀함수를 통한 수열, 조합 연습 중

# 10/31

### 15650 N과 M (2)

1. 인프런 강의 듣고 백트래킹, 이진트리에 조금 가까워졌다. 5일까지만 해도 진짜 계속 못 풀고 이해 안되서 정말 힘들었는데 이제는 재귀 함수에 대한 두려움을 조금 떨쳐냈다. 기존 해답들을 따르지 않고 내 식대로 풀었다는 것이 뿌듯하다.
